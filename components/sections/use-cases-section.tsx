    ...
    <section className="py-24">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Intro Container */}
          <div
            className="bg-white rounded-3xl p-8 relative min-h-[400px] group cursor-pointer overflow-hidden"
          >
          ...
          {/* First Use Case */}
          <div
            className={`${useCases[0].bgColor} rounded-3xl p-8 relative min-h-[400px] group cursor-pointer overflow-hidden`}
          >
            <div className="flex flex-col h-full relative z-10">
              <div className="flex justify-between items-start">
          ...
          {useCases.slice(1).map((useCase, index) => (
            <div
              key={index}
              className={`${useCase.bgColor} rounded-3xl p-8 relative min-h-[400px] group cursor-pointer overflow-hidden`}
            >
              <div className="flex flex-col h-full relative z-10">
                <div className="flex justify-between items-start">
